...
// this functions is used for multiple item
// the submitted value is a dec, its bin form should match the use answers
// such as "1001" -- checked, not checked, not checked, checke
function setValue(id, pos, checked) {
	var answer = parseInt(document.getElementById(id).value);
	if (checked)
		answer = answer | (1 << pos);
	else
		answer = answer & ( 0xFFF ^ (1 << pos));
